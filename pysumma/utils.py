...
# however this is old version of SUMMA TestCases
...
# This method is necessary, when user wants
# to run SUMMA with local execution file.
def download_executable_lubuntu_hs(save_filepath):
    ...
    executable_filepath = (save_filepath + '/' + resource_id + '/'
                           + resource_id + '/data/contents/' + resource_name)
    shutil.unpack_archive(executable_filepath,
                          extract_dir=os.path.dirname(executable_filepath))
    executable = (save_filepath + '/' + resource_id + '/'
                  + resource_id + '/data/contents/summa-master/bin')
    return os.path.dirname(executable)


def download_model_instance_sopron(resource_id):
    path = (os.getcwd() + '/' + resource_id + '/'
